...
const char* ssid = "ShaperJet"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "shaperjet0284"; // Your Wifi password, in case you have open network comment the whole statement.
